...
//{
//    CGRect tempReturnValue;
//    [invocation getReturnValue:&tempReturnValue];
//    returnValue = NSStringFromCGRect(tempReturnValue);
//}
//
//else if (strcmp(returnType, @encode(NSRange)) == 0)
//{
//    NSRange tempReturnValue;
//    [invocation getReturnValue:&tempReturnValue];
//    returnValue = NSStringFromRange(tempReturnValue);
//}
//else if (strcmp(returnType, @encode(Class)) == 0)
//{
//    Class tempReturnValue;
//    [invocation getReturnValue:&tempReturnValue];
//    returnValue = NSStringFromClass(tempReturnValue);
//}
//else if (strcmp(returnType, @encode(SEL)) == 0)
//{
//    SEL tempReturnValue;
//    [invocation getReturnValue:&tempReturnValue];
//    returnValue = NSStringFromSelector(tempReturnValue);
//}
